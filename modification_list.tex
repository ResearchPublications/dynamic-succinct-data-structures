...
Following a post-viva meeting with the supervisor, additional recommendations were identified and are listed as entries 24*--26* below. The asterisk (\texttt{*}) in the serial number distinguishes supervisor comments from the original examiner comments.
